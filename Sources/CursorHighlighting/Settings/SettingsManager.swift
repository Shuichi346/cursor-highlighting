...
extension Defaults.Keys {
    // スポットライト設定
    static let spotlightEnabled = Key<Bool>("spotlightEnabled", default: true)
    static let spotlightRadius = Key<Double>("spotlightRadius", default: 30.0)
    static let spotlightBlur = Key<Double>("spotlightBlur", default: 0.0)
    static let spotlightOpacity = Key<Double>("spotlightOpacity", default: 0.0)
    ...
    // キーストローク設定
    static let keyStrokeEnabled = Key<Bool>("keyStrokeEnabled", default: false)
